  ...
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        {loadingPayments ? (
          <div className="flex justify-center py-12" role="status" aria-label="Loading recent payments">
          ...
          <>
            <div className="hidden grid-cols-[minmax(0,1fr)_auto_auto] gap-3 border-b border-slate-100 bg-slate-50/70 px-5 py-2 text-[10px] font-bold uppercase tracking-[0.16em] text-slate-500 sm:grid">
              <span>Student</span>
              <span>Amount</span>
              <span>Status</span>
            </div>
            ...
            <div className="border-t border-slate-100 px-5 py-3 text-right">
              <Link href="/app/admin/finance" className="text-xs font-semibold text-sky-600 hover:text-sky-700">
