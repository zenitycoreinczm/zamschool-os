...
const CONTACT_TARGETS: Record<KnownRole, KnownRole[]> = {
  STUDENT: ["TEACHER", "PRINCIPAL", "DEPUTY_HEAD", "GUIDANCE_OFFICE"],
  PARENT: [
    "TEACHER",
    "PRINCIPAL",
    "DEPUTY_HEAD",
  ...
  TEACHER: ["STUDENT", "PARENT", "PRINCIPAL", "DEPUTY_HEAD"],
  PRINCIPAL: ["TEACHER", "PARENT", "STUDENT", "DEPUTY_HEAD", "BURSAR", "REGISTRAR"],
  DEPUTY_HEAD: ["TEACHER", "PARENT", "STUDENT", "PRINCIPAL"],
  BURSAR: ["PARENT", "PRINCIPAL"],
  PAYMENTS: ["PARENT", "PRINCIPAL"],
  GUIDANCE_OFFICE: ["STUDENT", "PARENT", "TEACHER", "PRINCIPAL"],
  ACADEMIC_ADMIN: ["TEACHER", "PRINCIPAL", "DEPUTY_HEAD"],
  HR_ADMIN: ["TEACHER", "PRINCIPAL"],
  ICT_ADMIN: ["PRINCIPAL", "TEACHER"],
  DISCIPLINE_ADMIN: ["STUDENT", "PARENT", "TEACHER", "PRINCIPAL"],
  REGISTRAR: ["TEACHER", "PRINCIPAL", "DEPUTY_HEAD"],
